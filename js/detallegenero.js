...
if (tipo == "pelicula") {
    let url = `https://api.themoviedb.org/3/discover/movie?api_key=cd21534ccf3ef8b078f7ac273cdf32ca&with_genres=${id}`
    ...
    let url = `https://api.themoviedb.org/3/discover/tv?api_key=cd21534ccf3ef8b078f7ac273cdf32ca&with_genres=${id}`
